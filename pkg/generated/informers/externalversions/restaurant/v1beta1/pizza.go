...
import (
	"context"
	restaurantv1beta1 "pizza-apiserver/pkg/apis/restaurant/v1beta1"
	...
	v1beta1 "pizza-apiserver/pkg/generated/listers/restaurant/v1beta1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutobusiV1beta1().Pizzas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutobusiV1beta1().Pizzas(namespace).Watch(context.TODO(), options)
			},
		},
