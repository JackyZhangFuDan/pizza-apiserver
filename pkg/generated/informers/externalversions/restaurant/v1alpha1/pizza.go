...
import (
	"context"
	restaurantv1alpha1 "pizza-apiserver/pkg/apis/restaurant/v1alpha1"
	versioned "pizza-apiserver/pkg/generated/clientset/versioned"
	internalinterfaces "pizza-apiserver/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "pizza-apiserver/pkg/generated/listers/restaurant/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutobusiV1alpha1().Pizzas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutobusiV1alpha1().Pizzas(namespace).Watch(context.TODO(), options)
			},
		},
