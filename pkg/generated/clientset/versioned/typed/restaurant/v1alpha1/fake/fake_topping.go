...
type FakeToppings struct {
	Fake *FakeAutobusiV1alpha1
}

var toppingsResource = schema.GroupVersionResource{Group: "autobusi.group.pizza.restaurant", Version: "v1alpha1", Resource: "toppings"}

var toppingsKind = schema.GroupVersionKind{Group: "autobusi.group.pizza.restaurant", Version: "v1alpha1", Kind: "Topping"}
